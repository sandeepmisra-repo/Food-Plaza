 ...
 * Last generated by Orchestration Designer at: 2019-JUN-18  04:23:08 PM
 */
public class GoogleTTS extends com.avaya.sce.runtime.BasicServlet {
	...
	public void servletImplementation(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		//SSL Certificate
            ...
            String ssml = "<speak><say-as interpret-as=\"s\">"+inputText+"</say-as></speak>";
...
//            String json = "{\"audioConfig\":{\"audioEncoding\":\"LINEAR16\",\"pitch\":0.00,\"speakingRate\":1.00},\"input\":{\"text\":\"\"},\"voice\":{\"languageCode\":\"en-US\",\"name\":\"en-US-Wavenet-D\"}}";
            String json = "{\"audioConfig\": {\"audioEncoding\": \"LINEAR16\",\"sampleRateHertz\":8000,\"effectsProfileId\":[\"telephony-class-application\"],\"pitch\": \"-1.6\",\"speakingRate\": \"0.7\"},\"input\": {\"ssml\": \"\"},\"voice\": {\"languageCode\": \"hi-IN\",\"name\": \"hi-IN-Wavenet-A\"}}";
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("TTSError", 0, true, "Default");
		list.add(aGoto);
